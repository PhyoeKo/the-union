...
abstract class AppColors {
  static const primaryColorGradient = LinearGradient(
    colors: [
      Color(0xffD87631),
      Color(0xffD15B22),
    ],
  );
  static const Color primaryColor = Color(0xFFD56829);
  static const Color secondaryColor = Color(0xFF502510);
  static const Color pageBackground = Color(0xFFFAFBFE);
  static const Color lightBlueColor2 = Color(0xffe8ecff);
  static const Color whiteColor = Color(0xffffffff);
  static const Color grayColor = Color(0xffD0D0D8);
  static const Color topGrayColor = Color(0xffD1D2D6);
  ...
  static const Color colorPrimaryText = Color(0xFFD56829);
  static const Color colorGreyText = Color(0xff696969);
  static const Color colorBlackText = Color(0xFF000000);
  static const Color colorInactiveText = Color(0xffe3e3e3);
  static const Color colorRed = Color(0xffE60E11);
